                ...
                {clicked && clickedProject && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed  top-10 left-5 md:left-[50%] lg:left-[50%]  z-50 w-[90%] max-w-2xl max-h-[85vh] overflow-y-auto bg-[rgba(10,6,25,0.97)] border border-[rgba(147,51,234,0.35)] rounded-2xl shadow-2xl shadow-purple-900/40 p-10 flex flex-col gap-6"
                        >
                            {/* Close button */}
                            <button

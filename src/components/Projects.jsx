    ...
    return (
        ...
        >
            <div className="w-full">
                <h2 className="text-2xl md:text-5xl lg:text-6xl text-[#DDDDDF] font-semibold">Featured Projects</h2>
                ...
                {clicked && clickedProject && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed  top-10 left-0  md:left-20 md:top-32 lg:left-80  z-50  max-w-2xl max-h-[85vh] overflow-y-auto bg-[rgba(10,6,25,0.97)] border border-[rgba(147,51,234,0.35)] rounded-2xl shadow-2xl shadow-purple-900/40 p-10 flex flex-col gap-6"
                        >
                            {/* Close button */}
                            <button

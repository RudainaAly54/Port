...
{/* Left panel ABout me */}
  ...
  <h2 className="text-6xl text-[#DDDDDF] font-semibold mb-5">About Me</h2>

  <motion.p
    initial={{ opacity: 0, x: -50 }}
    whileInView={{ opacity: 1, x: 0 }}
    transition={0.7}
    className="text-[#DDDDDF] text-lg"
  >
  ...
  <motion.p
    ...
    className="text-[#DDDDDF] text-lg"
  >
    Along the way, I got to be part of a team that won <a href="https://drive.google.com/file/d/1gDVBngSFkN1OJa38PGFaRISW4gfQiqFN/view" className="underline cursor-pointer"> a Best Project Award</a>, which really showed me how much impact good communication, teamwork, and problem-solving can have when everything clicks together. I learned that strong products aren’t built alone — they’re shaped through collaboration and constant iteration.
  </motion.p>
